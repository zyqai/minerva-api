...
DROP TABLE IF EXISTS `_adminusers`;
...
CREATE TABLE `_adminusers` (
  ...
  UNIQUE KEY `idx__adminusers_adminUserId` (`adminUserId`)
...
LOCK TABLES `_adminusers` WRITE;
/*!40000 ALTER TABLE `_adminusers` DISABLE KEYS */;
INSERT INTO `_adminusers` VALUES (1,'admin','admin',1,1,'admin','admin','2023-12-17 17:52:57','2023-12-17 17:52:57');
/*!40000 ALTER TABLE `_adminusers` ENABLE KEYS */;
UNLOCK TABLES;
