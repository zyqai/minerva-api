CREATE PROCEDURE `Usp_ProjectRequestWithDetailsInsert`(
...
BEGIN
    ...
    BEGIN
        ...
        INSERT INTO _projectrequests (projectId, tenantId, remindersAutoId, projectRequestName, projectRequestDescription, createdOn, createdBy,peopleid)
        VALUES (in_projectId, in_tenantId, in_reminderId, in_requestName, in_requestDescription, NOW(), in_createdBy,in_peopleId);
        
       
        SET last_requestId := LAST_INSERT_ID();
                
        INSERT INTO _projectrequesturls (projectId, tenantId, projectRequestId, requestURL, token, createdOn, createBy)VALUES
		(in_projectId, in_tenantId, last_requestId, in_requestURL, in_token, CURRENT_TIMESTAMP, in_createdBy);
