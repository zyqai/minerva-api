CREATE DEFINER=`root`@`localhost` PROCEDURE `usp_tenantCreate`(
    ...
    IN p_tenantDescription varchar(1000),
...
BEGIN
    INSERT INTO `_tenants` (
        ...
        `city`, `stateid`,`createdBy`,`tenantDescription`
    )
    VALUES (
        ...
        p_city, p_stateId,p_createdBy,p_tenantDescription
    );
